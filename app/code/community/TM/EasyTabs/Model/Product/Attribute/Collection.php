<?php
if (class_exists('Mage_Catalog_Model_Resource_Product_Attribute_Collection')) {

    class TM_EasyTabs_Model_Product_Attribute_Collection  extends Mage_Catalog_Model_Resource_Product_Attribute_Collection
    {
